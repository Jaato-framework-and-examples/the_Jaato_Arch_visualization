...
// threading via event.get(field) (the server hoists the validated payload onto
// the bus event). Identical .jaato/ assets to examples/python-sdk (the reactor
// scripts are daemon-side python). The reactor + scripts live in .jaato/, so this
// passes workspacePath + configRoot.
//
